...
describe("TypeBox Resolver", () => {
  it("resolver core schema to typebox validator", () => {
    ...
    const typeBoxSchema = Type.Object({
      ...
      isActive: Type.Required(Type.Boolean()),
      ...
      hobbies: Type.Required(Type.Array(Type.String())),
      cities: Type.Required(Type.Tuple([Type.String(), Type.Number()])),
      date: Type.Required(Type.Union([Type.Date(), Type.String()])),
    });
